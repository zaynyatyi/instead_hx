...
class SteadDispatcher
{
	...
	public static function look():Void
	{
		ifaceCmd("\"look\"");
		refreshInterface();
	}

	private static function refreshInterface():Void
	{
		getTitle();
		getWays();
		getInv();
	...
	private static function getInv():Void
	{
	...
	private static function getPicture():Void
	{
	...
	private static function getMusic():Void
	{
	...
	private static function showPicture(path:String):Void
	{
	...
	private static function copyAccross(e:Event):Void
	{
	...
	private static function playMusic(path:String):Void
	{
	...
	private static function ifaceCmd(command:String):Void
	{
	...
	private static function setContent(id:String, content:String, field:EField):Void
	{
