intro_1 = room
{
    ...
    dsc = function (s)
        ...
        Tumult of colours and bright splashes... Illegible silhouettes of
        men...  Faces... No... There are masks... Gleams of costums and
        ...
        Blazing attires dissapear and become winking of huge amount of
        multicoloured lamps... What is it? Garlands?
...
intro_2 = room
{
    ...
    dsc = function (s)
        ...
        with huge number of electornic equipment.
        Everything is flikering by millions of lamps and huge amount of
        multicolour lights.
        ...
        May be there was some kind of accident? Whats happend to me?^
        ...
        I can’t even move.
        Alarm, whipped by sense of fear, increase many mupltiplly. Where I am?^
        Finally, I can discern some noices.
        Squeaking of machines, flicks of handles and knobs.^
        – Do not resist, or it will be even worse! — green eyes of man who bends
        over me intently look at me.^
...
--    end,
    dsc = function (s)
        if s._visit == 1 then
            ...
            There is soemthing in my hand. I raise my head and millions
            ...
            Who it can be?^
            What’s happend here? The revolver had been shoot from.
            So, neghbours heard the shooting and called the police.
            ...
            never had a chance to understand what happend here exactly.^
            ...
            Plastic and plycarbons.
            Only few can allow to use true wood furniture nowdays...
            ]];
            return;
        end
        if s._visit == 2 then
...
revolver = obj
{
    ...
    exam = function (s)
        ...
        p [[I examine revolver.
        The barrel is strengthen by accelerator, and bullets must be
        bursting in it. Serious gun for serious deals.
        ]];
        if s._bullets == 4 then
            p [[There must be six bullets in revolver’s drum.
            But two of them are missing now.
            ]];
        end
        if s._bullets == 0 then
            p [[The revolver’s drum is empty.
            ]];
        end
        return;
    end,
    ...
    drop = function (s)
        if here() == hotel_room or
            ...
            p [[I don’t want to leave revolver here. It is a bad idea.
            There are many mine fingerprints on it.
            ]];
            return false;
        end
        return 'I drop revolver.';
    end,
    useit = function (s)
...
hotel_bed = obj
{
    ...
    talk = function (s, w)
        p [[May be some romantic persons cry to the pillow becouse of unrequited
        love. But I’m not in this kind of situation.
        Besides I don’t like to complain about my problems to lifeless objects.
        ]];
        return;
    end,
};
...
hotel_bedside_table = obj
{
    ...
    exam = function (s)
        return 'I examine bedside-table. It’s empty.';
    end,
    useit = function (s)
...
hotel_door = obj
{
    ...
    talk = function (s, w)
        p [[There is nobody behind the door. Talking to empty space is unreasonable.
        ]];
        return;
    end,
};
...
hotel_fire_stairs_floor_5 = room
{
    ...
    dsc = function (s)
        if s._just_enter then
            ...
            I misscalculate my stnregth slightly and my jump turns out awkward.
            I reach ladder successfully, but pound my forehead at footstep.
            Brain explode with pain again. All start to float before my eyes.
            I grasp the ladder as hard as I can, trying not to fall.
            After a couple of minutes vertigo goes away and I look around.^
            I’m at fire ladder.
            Rust is strew from the old footsteps, but ladder looks solid on the
            whole.^
            I can see inner court from here. Brick walls, some wires, which
            stretch on different levels. Only light here is coming from windows.
            So I can’t see very clear course of the approaching twilight,
            which fastly covers the city.^
    ...
    exit = function (s, to)
        if to == main then
            p [[I dont want to risk and jump back. I don’t want to fall down
            from here.
            ]];
            return false;
        end
...
hotel_window_5 = obj
{
    ...
    exam = [[This is a window I jump from.]],
    take = function (s)
        p [[I can’t take the window with me.
        ]];
        return false;
    ...
    talk = function (s, w)
        ...
        But now I have no time to this nonsence.
        ]];
    end,
};
...
hotel_iron_stairs = obj
{
    ...
    exam = function (s)
       ...
       transverse rods boiled to them. It’s still solid despite of it’s old age.
       There are small platforms on every level of the floor.
       ]];
       return;
    end,
    take = function (s)
    ...
    used = function (s, w)
        p [[Ladder dosn’t need to manipulate with.
...
hotel_fire_stairs_floor_4 = room
{
    ...
    dsc = function (s)
        if s._just_enter then
            ...
            and scare away pidgeons. They flew, indignantly flapping their
            wings.^
    ...
    exit = function (s, to)
        if to == main then
            p [[It’s a long way to window. I don’t want to risk trying to jump.
            I don’t want to fall down becouse of vertigo.
            ]];
            return false;
        end
    end,
...
hotel_window_4 = obj
{
    ...
    exam = function (s)
        ...
        of plastic. Not everyone can allow to own real plant nowdays.
        ]];
        return;
    end,
    take = function (s)
...
hotel_fire_stairs_blood_4 = obj
{
    ...
    exam = function (s)
        if not s._examined then
            s._examined = true;
            p [[I examine it closer and to my horror I realise that this is a
...
hotel_fire_stairs_floor_1 = room
{
    ...
    dsc = function (s)
        ...
        The strong smell of cats and rotten garbage is knicking over.
        ]];
        return;
    end,
...
police_car_1 = room
{
    ...
    dsc = function (s)
        ...
        – And why is that so?
        – I bought the coffee and dounts.^
        – Oh, you call that slops the «coffee»? And that stale rubbish was
        the donuts? Thank you that you clear it out to me. I never been able to
...
police_car_2 = room
{
    ...
    dsc = function (s)
        ...
        I feel that I have been grabed by the hand and then have been pulled
        from the garbage.^^
        – He is heavy, damn...^
        ...
        – It’s very funny. Grab his feet, wit...
        ]];
        return;
    end,
...
police_car_4 = room
{
    ...
    dsc = function (s)
        ...
        statics.^
        – Oh, Nikki, my dear! With  my huge pleasue I’m hurry to respond to
        you that we are work through the call. We’ve got the noisemaker.
        We’ll bring him soon. Please, prepare to him worthy appartements.^
...
police_car_5 = room
{
    ...
    dsc = function (s)
        ...
        Vertigo slighlty abate, but I feel sick still.^
        ...
        rambling here densly.
        The evening comes to rule already. The street lamps, showcases of
        shops and cafes are light up.^
        Smooth light of glass cases and frsh air are relaxing and quitly.
...
police_car_6 = room
{
    ...
    dsc = function (s)
        ...
        processed and cpmpacted wastes into the ocean. This makes the city
...
police_car_7 = room
{
    ...
    dsc = function (s)
        ...
        normal land.^
        How can I remember this? I have no idea. It seems that permanent meory
        is not lost.  That means that I have trouble with short-term memory...
        ]];
        return;
    end,
...
police_car_8 = room
{
    ...
    dsc = function (s)
        ...
        Our people worked very competently, close round everythng – not even
        ...
        burst point-blank...^
        – Mmmm... poor fellow... And what, is he dead?^
...
police_car_11 = room
{
    ...
    dsc = function (s)
        ...
        quiet. And only female voice on the radio says over and over agin
...
police_car_12 = room
{
    ...
    dsc = function (s)
        ...
        not leave him any chances. He died to the momeny I get out from the
        car.
        ]];
        return;
    end,
...
gloomy_man_corpse = obj
{
    ...
    exam = function (s)
        if not s._examined then
            ...
            have more than enough troubles. I dont want that police tagged me
            as «copkiller». In his pocket I found keys and the credit card
    ...
    talk = function (s, w)
        p [[In past century different books about some mages and sorceres was
        ...
        necromants was able not only to talk with the dead people but even
        ressurect them. Unfortunately, I’m not that sort of man.
        ]];
        return;
    end,
};
...
felchi_credit_card = obj
{
    ...
    useit = function (s)
        p [[I click on plastic with my nail. Hmm... it is not a bad melody I’ve
        got here...  I think I should compose a hit at my spare time...
        ]];
        return;
    end,
    used = function (s, w)
    ...
    talk = function (s, w)
        ...
        qustions about it, I should consult in the nearest bank department. I
...
felchi_key = obj
{
    ...
    exam = function (s)
        if not s._examined then
            s._examined = true;
            p [[It is a key on a keychain with a little monkey on it. This key
            is corresponding to modern tendencies in high level of house
            safety.  The key at the same time is a mechanical and contain some
            electronic part. This combokey was belong to gloomy guy.
            ]];
        else
            p 'This is a combokey on a keychain with a little monkey on it.';
        end
        return;
    end,
    take = function (s)
...
policeman_rick_corpse = obj
{
    ...
    used = function (s, w)
        p [[I have enought problems with the law already. I don not want that
        they think that I am a copkiller.
        ]];
        return;
    end,
    talk = function (s, w)
        ...
        but even ressurect them. Unfortunately, I am not this kind of person.
        ]];
        return;
    end,
};
...
quay_police_car = obj
{
    ...
    exam = function (s)
        if not s._examined then
            ...
            p [[I search the police car crefully, trying not to leave my
...
quay_police_car_computer = obj
{
    ...
    take = function (s)
        p [[The computer is builted in instrument panel of police car. I can
        not take it with me.
        ]];
        return false;
    end,
    useit = function (s)
        if s._opened then
            p [[There is a memory block missing here. It is imposible to turn
            it on.
            ]];
            return;
        end
        if not s._used then
           s._used = true;
           p [[THe computer is proided with a SPG system. It is a system of
    ...
    used = function (s, w)
        if w == knife then
            if not s._opened then
                ...
                p [[I have pulled the memory block from the comuter already. I
                don’t want anything more from it.
                ]];
                return;
            end
        end
    ...
    used = function (s, w)
        ...
        if w == flashlight_battery then
            if not flashlight_battery._sticked then
                ...
                stick it uwing the gum. I hope that this construction will not
                fall apart.
                ]];
                return;
            end
...
quay_police_car_radio = obj
{
    ...
    take = function (s)
        p [[I don’t need the radio transmitter. I can’t break it off
        anyway.
        ]];
        return false;
    end,
    ...
    life = function (s)
        ...
        if s._index > 4 then
            ...
            if not (here() == quay_police_car_radio_dlg) then
                ...
                if v == 3 then
                    p [[Alarmed female voice from the radio said:
                    «Central! This is fifty fifth. Please awnswer!»
                    ]];
                    return;
                end
                if v == 4 then
...
quay_red_car_computer = obj
{
    ...
    take = function (s)
        p [[The cumputer is built in a panel of the car. I can’t take it
        with me.
        ]];
        return false;
    end,
    useit = function (s)
        if not s._used then
            ...
            place the car have leave from. It is a corner of Ruzvelt street
            and Valor avenue.
            ]];
        else
...
chewing_gum = obj
{
    ...
    dsc = nil,
    exam = function (s)
        p 'It’s a chewing gum.';
        if not s._examined then
            s._examined = true;
            p 'Chewing gum has a fruit taste, as it’s said on the label.';
        end
        return;
    end,
    take = function (s)
    ...
    useit = function (s)
        p [[Fruit chewing gum are prefered by children. And I just don’t want
        it right now anyway.
        ]];
        return;
    end,
...
knife = obj
{
    ...
    used = function (s, w)
        ...
        if w == bottle_of_cognac then
            p [[Should I use the cognac on the knife? I don’t understand how I
            can do it.
            ]];
            return;
        end
        if w == game_pad then
            p [[I don’t have any ideas on this topic...
            ]];
            return;
        end
    end,
...
flashlight = obj
{
    ...
    exam = function (s)
        if not s._bulb then
            if not s._batteries then
                ...
                is no battery. So I just don’t know is it woking at all...
                ]];
            else
        ...
        if not s._batteries then
            p [[It’s a flashlight. The electric bulb is on place, but there is
            no battery in the flashlight.
            ]];
            return;
        end
        p [[Metal flashlight. When I turn the switch, it gives dim but stable
        ray of light.
        ]];
        return;
    end,
    ...
    useit = function (s)
        ...
        if not s._activated then
            s._activated = true;
            p [[I turn the switch. The flashlight is lighting up surroundings
            with a dim light.
            ]];
        else
            s._activated = false;
            p [[I press the button and switch off the flashlight.]];
        end
        return;
    end,
    used = function (s, w)
        ...
        if w == bottle_of_cognac then
            p [[The cognac is needed to pour it in. Into the man. Slowly and
            anjoying by it. How the flashlight can be used for it?
            ]];
            return;
        end
        if w == game_pad then
            p [[Should I use the game pad on the flashlight? It’s a strange
            idea...
            ]];
            return;
        end
        if w == bulb then
            ...
            remove (bulb);
            s._bulb = true;
            p [[I screw the electric bulb in the flashlight. It’s slightly
            bigger than needed, but threading is suits luckely.
            ]];
            return;
        end
        if w == flashlight_accumulator then
            ...
            s._batteries = true;
            s._activated = false;
            p [[I insert the accumulator in the flashlight.
            ]];
            return;
        end
    end,
...
in_red_car_to_city = room
{
    ...
    dsc = function (s)
        ...
        Ruzvelt street and Valor avenue.
        ]];
        return;
    end,
    obj = { vway('1', '{Next}', 'ruzvelt_and_valor_cross') },
};
